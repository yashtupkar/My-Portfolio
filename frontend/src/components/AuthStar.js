...
const AuthStar = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center select-none">
        ...
        >
          <img
            src="/images/star.png"
            alt="Star"
            className={`w-14 h-14 md:w-20 md:h-20 transition-transform floating-animation ${
              tapCount > 0 ? "scale-110 animate-pulse" : "scale-100"
            }`}
          />
      ...
      {popup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80 transition-opacity duration-300">
          <div className="relative bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg text-center select-none">
            <h1 className="text-xl font-bold text-gray-800 dark:text-white">
              ✨ Secret Access! ✨
            </h1>
            <SecretCodeVerification />
