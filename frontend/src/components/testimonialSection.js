...
const TestimonialSection = () => {
  return (
    <div className="w-full h-fit flex flex-col  md:flex-row gap-2 mt-20  md:p-4">
      <div className="w-1/2  ">
        <div>
      ...
      <div className="w-full flex gap-2 mt-6 md:mt-0">
        
        <div className="w-96 h-fit md:h-96 rounded-xl border flex flex-col gap-2 md:gap-1 justify-between border-gray-600 text-gray-500 dark:text-gray-300 p-2 md:p-4">
